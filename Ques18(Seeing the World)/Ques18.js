...
var worldvisit = ["Africa", "Yeman", "Mexico", "St. Louis", "Brazil"];
console.log("Original Order: ", worldvisit);
console.log("\nAlphabetical order without modification:", __spreadArray([], worldvisit.sort(), true)); // Alphabetical order(sort)
console.log("Original Array: ", worldvisit);
console.log("\nReverse Alphabetical order without modification", __spreadArray([], worldvisit, true).reverse());
console.log("Original Array: ", worldvisit);
