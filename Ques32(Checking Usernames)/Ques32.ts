...
let userNames:string[]=["Ahmed","Haris","Anoshia","Hamza","Mustafa","asra"];
let newUsernames:string[]=["Kamran","ANOSHIA","Siraj","ahmed","Shayan","Asra"]
...
for (let newUsername of newUsernames){
    ...
    for(let userName of userNames){
        ...
        console.log(`Username "${newUsername}" is already taken. Please choose another username.`);
        isAvailable = false;
        break;
    }
}
