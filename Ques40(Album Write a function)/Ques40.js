...
var album1 = make_album("Billie Eilish", "What Was I Made For?", 7);
var album2 = make_album("Taylor Swift", "You're Losing Me", 4);
var album3 = make_album("Elvis Presley", "Can't Help Falling in Love", 12);
console.log(album1);
console.log(album2);
console.log(album3);
