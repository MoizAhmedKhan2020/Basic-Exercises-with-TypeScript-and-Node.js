...
function car_maker(manufacturer, model, color, optional) {
    console.log("Manafacture is '".concat(manufacturer, "', color ").concat(color, ", model ").concat(model, ", Optional feature: ").concat(optional));
}
